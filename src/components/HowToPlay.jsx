...
const HowToPlay = () => {
    return (
        <section className="min-h-screen flex flex-col justify-center items-center py-16 lg:space-y-8 bg-gradient-to-b from-black to-[#304849]">
            <h1 className="px-10 py-2 rounded-full uppercase text-5xl font-bold text-white mb-10">
                How to play
            </h1>
            <div className="flex items-center space-x-16 mr-16">
                ...
                <p className="text-right font-semibold text-white w-3/5 pl-4">
            ...
            <div className="flex items-center space-x-16 ml-16">
                <p className="text-left font-semibold text-white w-3/5">
