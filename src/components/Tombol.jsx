...
const Tombol = () => {
    return (
        <section className="min-h-80 flex flex-col justify-center items-center bg-[#304849]">
            <h1 className="text-2xl text-white font-semibold mb-12 text-center w-4/5 lg:w-2/5">
                Tombol - tombol yang digunakan untuk memainkan game The
                Hunchback From Land Of Java :
            </h1>
            <div className="flex flex-col justify-center items-center lg:flex-row lg:space-x-10">
